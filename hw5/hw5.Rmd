...
```
Q5:
According to the results generated above, the best parameters are intelligence, total, speed and strength. 
```{r}
set.seed(7)
data4 = data3
...
results <- rfe(data4[,1:7], data4[[8]], sizes=c(1:8), na.action=na.exclude, rfeControl=control)
